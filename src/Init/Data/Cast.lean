...
This typeclass was introduced to a uniform simp normal form for such morphisms.
...
In Mathlib there will be such a homomorphism whenever `R` is an additive monoid with a `1`.
-/
